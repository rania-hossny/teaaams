...
const Posts = (props) => {
  ...
  async function getPosts(){
    await fetch(`https://boiling-shelf-43809.herokuapp.com/post/60ef50c9cb1b8600222633ca/allPosts`,{
      headers:{
        "authorization":`${token}`
      }
    }).then(resp=>resp.json())
  ...
  const createpost=(postBody)=>{
    ...
    fetch(`https://boiling-shelf-43809.herokuapp.com/post/60ef50c9cb1b8600222633ca/addPost`,
    {
        method:"POST",
        headers:{
              ...
              <div className={styles.imginputpost}>
                  <img src={url} style={{margin:"0px",objectFit:"fill"}}/>
                    ...
                    <Row className={styles.userActivities}>  
                    {
                      data.length == 0 ? <>
                      <div>
                        <img src={addpostimg} style={{width:"733px",marginLeft: "96px",paddingLeft: "60px"}}/>
                            ...
                            <li key={record._id} className={styles.clist}>
                              ...
                              <div className={styles.headercomment}>
                                ...
                                <div
                                 ...
                                 >
                                  <ul>
                                    <li onClick={()=>showingComModel(item._id,record._id,record.commentBody)}>Edit</li>
